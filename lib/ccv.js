var defaultCascade = require('./cascade.js'),
...
var ccv = module.exports = exports = {
  ...
  detect_objects : function (canvas, interval, min_neighbors, cascade) {
      var params = get_named_arguments(arguments, ["canvas", "interval", "min_neighbors", "cascade"]);
      params.canvas = ccv.grayscale(params.canvas);
      params.cascade = cascade || defaultCascade;
